        ...
        if len(faces) != 0:
            ...
            for k in range(len(faces)):
                ...
                if min(e_distance_list) < 0.4:
                    ...
                    name_namelist[k] = my_dict["person_"+str(int(similar_person_num)+1)]
                    print("May be person "+my_dict["person_"+str(int(similar_person_num)+1)])
                else:
